...
Para visualizar los pasos que implemente para el ETL, puede seguir este enlace: [ETL](ETL.ipynb)
...
Para visualizar los pasos que se implemento en este proceso, puede seguir este enlace: [Feature Engineering](Feature%20Engineering.ipynb)
...
Para visualizar los pasos que se implemento en este proceso, puede seguir este enlace: [EDA](EDA.ipynb)
...
Para visualizar los pasos que se implemento en este proceso, puede seguir este enlace: [Sistema de Recomendación](Sistema%20de%20Recomendacion.ipynb)

## **Desarrollo de la API**
![Google Cloud](https://img.shields.io/badge/google-cloud-333333?style=flat&logo=google-cloud)
![FastAPI](https://img.shields.io/badge/-FastAPI-333333?style=flat&logo=fastapi)


Una vez que tenemos los datasets necesarios para las funciónes y para el Sistema de Recomendación, procedemos a desarrollar la API, que en este caso utilizamos el framework `FastAPI` e hicimos el deploy en `Google Cloud`.
